...
using SkillsBridge.Data;
using SkillsBridge.Models;

namespace SkillsBridge.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Course(string Name)
        {
            ...
            if (Name != null && Name.Length > 0)
            {
                ...
                return PartialView("_Partial/_coursePartial", search);
            }
            var Course = _context.Course.ToList();
            return PartialView("_Partial/_coursePartial", Course);
        }
